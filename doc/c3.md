...
![Arquitetura do Projeto]<img src="images/arquitetura_api.png" alt="Arquitetura do Projeto" width="400">
...
| 3.1.2 Arquitetura do Projeto | <img src="images/arquitetura_api.png" alt="Arquitetura do Projeto" width="400"> |
| 3.1.3 Fluxo de Dados: | <img src="images/fluxo_dados.jpg" alt="Arquitetura do Projeto" width="400"> |
...
- **3.1.4.5 Imagem mariadb-replicas**
...
- **3.1.4.7 Base de Dados - Estrutura**
...
Obs: o DELETE só vai deletar um cliente que não tenha entregas associadas ao  id do mesmo
...
Assim, o trabalho pode ser executado via *cmd* da seguinte maneira, após se mover até à pasta **scr**:  

em **\desktop\food\src**
docker-compose.dev -> `docker compose -f docker-compose.dev.yaml up --build`  
docker-compose.prod -> `docker compose -f docker-compose.prod.yaml up`  
...
**Detalhe:** em caso de execução do *docker-compose.prod*, é necessário fazer *login* no DockerHub para poder acessar às imagens do repositório público do projeto para o mesmo ser executado).  
...
- (meter print do apidocs ou postman)
